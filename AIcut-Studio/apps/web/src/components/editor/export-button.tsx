      ...
      <PopoverTrigger asChild>
        ...
        >
          <div className="flex items-center gap-1.5 bg-linear-270 from-[#2567EC] to-[#37B6F7] rounded-[0.8rem] px-4 py-1 relative shadow-[0_1px_3px_0px_rgba(0,0,0,0.65)]">
            ...
            <span className="text-[0.875rem] z-50">导出视频</span>
                    ...
                    >
                      ...
                      >
                        <div className="flex items-center space-x-2">
                          ...
                          <Label htmlFor="low">低 - 文件体积最小</Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="medium" id="medium" />
                          <Label htmlFor="medium">中 - 效果平衡</Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="high" id="high" />
                          <Label htmlFor="high">高 - 推荐选项</Label>
                        </div>
                        <div className="flex items-center space-x-2">
              ...
              {isExporting && (
                <div className="space-y-4">
                  <div className="flex flex-col">
                    ...
                    <Progress value={Math.min(100, progress)} className="w-full" />
                  </div>
